...
public class ReplyController {
	...
	public ResponseEntity<String> addReply(@RequestBody ReplyVO vo){
		/*
		 * @RequestBody 애노테이션은 키, 값 쌍의 JSON 형태로 전송된 데이터를 ReplyVO 객체 타입으로 변경해 준다.
		 */
		...
		try {
			...
			//댓글 저장 실패시 예외 에러 메시지와 나쁜상태 코드가 반환
		}
		return entity;
	}//addReply()
	
	//게시판 번호에 해당하는 댓글 목록 => get 방식
