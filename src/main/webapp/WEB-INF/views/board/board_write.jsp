...
<body>
	...
	<%--action 속성을 생략하면 이전 매핑주소인 board_write가 액션 매핑주소가 된다. 같은 컨트롤러 클래스 내에서 메서드가 
	오버로딩이 된 경우는 동일 메서드명은 사용 가능하고 , 같은 매핑주소도 사용가능하다. 동일 매핑주소 구분은 get or post 메서드 방식으로 구분한다.--%>
	...
	<%--input 태그의 네임 피라미터 이름과 빈클래스 변수명은 반드시 같게 한다. 이유는 그렇게 해야지만 스프링 컨트롤러에서
